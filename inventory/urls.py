...
from . import views
from .views import PurchaseListView, MenuItemListView, IngredientDelete, IngredientListView, Profit, PurchaseDetailView, RecipeRequirementListView
...
urlpatterns = [
    ...
    path('purchase/', PurchaseDetailView.as_view(), name='purchase_item'),
